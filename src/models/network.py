...
class ImgtoClass_Metric(nn.Module):
    ...
    def cal_cosinesimilarity(self, input1, input2):
        ...
        for i in range(B):
            ...
            query_sam = query_sam / query_sam_norm  # query_sam.shape: torch.Size([441, 64])
            ...
            for j in range(len(input2)):
                ...
                support_set_sam = support_set_sam / support_set_sam_norm  # support_set_sam.shape: torch.Size([64, 2205])
