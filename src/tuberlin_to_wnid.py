...
zero_dir = '../dataset/TUBerlin/zeroshot/'

filetmp = os.path.join(zero_dir, 'ImageResized_ready_filelist_train.txt')
...
# make correspondance matrix from tuberlin categories to imagenet classes
wn_matrix = dict()
...
wn_matrix_np = np.zeros((220, 1000))
