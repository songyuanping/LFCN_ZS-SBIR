...
def visualize_ranked_results(distmat, dataset, width=224, height=224, save_dir='', topk=10, root_dir=''):
    ...
    for q_idx in range(num_q):
        qimg_path = os.path.join(root_dir, query[q_idx])
        ...
        for g_idx in indices[q_idx, :]:
            ...
            gimg_path = os.path.join(root_dir,gallery[g_idx])
            gpid = gpids[g_idx]
            invalid = False
