...
class GATLayerImp3(GATLayer):
    ...
    def forward(self, data):
        ...
        nodes_features_proj_lifted_weighted = torch.tensor(nodes_features_proj_lifted * attentions_per_edge,
    ...
    def aggregate_neighbors(self, nodes_features_proj_lifted_weighted, edge_index, in_nodes_features, num_of_nodes):
        ...
        # print("nodes_features_proj_lifted_weighted:", nodes_features_proj_lifted_weighted)
        # print("trg_index_broadcasted:", trg_index_broadcasted)
